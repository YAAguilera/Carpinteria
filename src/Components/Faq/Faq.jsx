...
const Faq = ({question, answer, isDrop, onDrop}) => {
  ...
  return (
    <article className={`${isDrop.isOpen ? 'lg:h-48 h-auto' : 'h-14'} transition-all duration-200 bg-gray-200 border-secondary border-2 px-4 shadow-md rounded-3xl lg:w-full w-full  pb-2 cursor-pointer`} onClick={onDrop}>
